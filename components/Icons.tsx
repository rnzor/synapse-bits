...
export const IconWand = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m5 8 6 6"/><path d="m4 14 6-6 2-3"/><path d="M2 12h1"/><path d="M2 22h1"/><path d="m2 2 4 4"/><path d="M12 2v1"/><path d="m20 2-4 4"/><path d="M22 12h-1"/><path d="M22 22h-1"/><path d="m22 2-4 4"/><path d="M12 22v-1"/></svg>
);
...
export const IconHeart = ({ className, fill }: { className?: string, fill?: boolean }) => (
...
export const IconFire = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.1.2-2.2.6-3.3.7 2.22 1.9 3.3 2.9 3.3z"/></svg>
);
...
export const IconDiscord = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M8.5 20.25c2.5 1.25 5.5 1.25 8 0 0 0-1.5-2.5-1.5-3.5 0-3-2-4.5-5-4.5s-5 1.5-5 4.5c0 1 0 2.5-1.5 3.5Z"/><path d="M19 5.5s-1.5-1-3.5-1c-2.5 0-4 1.5-4 1.5s-1.5-1.5-4-1.5c-2 0-3.5 1-3.5 1s-2.5 4.5-1.5 10c1 4.5 4 6 4 6s1.5-1.5 2-3c-1.5-.5-2.5-2-2.5-2s.5.5 3 1 5 0 8-1c2.5-.5 3-1 3-1s-1 1.5-2.5 2c.5 1.5 2 3 4 6 1-5.5-1.5-10-1.5-10Z"/><path d="M9 10a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Z"/><path d="M15 10a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Z"/></svg>
);

export const IconGoogle = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"/><path d="M12 22C6.48 22 2 17.52 2 12S6.48 2 12 2s10 4.48 10 10-4.48 10-10 10zm-1-7h2v2h-2zm2-2h-2V7h2z"/><text x="12" y="17" fontSize="10" textAnchor="middle" fill="currentColor" fontFamily="sans-serif" fontWeight="bold">G</text></svg>
);
...
export const IconBookmark = ({ className, fill }: { className?: string, fill?: boolean }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={fill ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"/></svg>
);
